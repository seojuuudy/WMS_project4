...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/assets/vendors/select2/select2.min.css" />
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/assets/vendors/select2-bootstrap-theme/select2-bootstrap.min.css" />
  ...
  <body>
    ...
    <script src="${pageContext.request.contextPath }/resources/assets/vendors/select2/select2.min.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/vendors/typeahead.js/typeahead.bundle.min.js"></script>
    ...
    <script src="${pageContext.request.contextPath }/resources/assets/js/typeahead.js"></script>
