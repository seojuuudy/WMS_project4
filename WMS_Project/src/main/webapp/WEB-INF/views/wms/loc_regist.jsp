...
<div class="main-panel">
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">위치 등록하기</h4>
              <form action="RegistLocPro.wms" class="form-sample"  method="post" onsubmit="return submitCheck();" id="registForm">
                <p class="card-description">warehouse location regist</p>
                
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">구역명</label>
                      <div class="col-sm-9">
                        <span class="form-control">${param.wh_area }</span>
                      </div>
                    </div>
                   </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">신규 위치명</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="wh_loc_in_area" id="wh_loc_in_area" required="required"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="template-demo" style="text-align: right;">
	                 ...
	                 <input type="submit" id="sub-btn" class="btn btn-primary mr-2" value="등록" location.href='RegistLocPro.wms?wh_area_cd=${param.wh_area_cd }'">
