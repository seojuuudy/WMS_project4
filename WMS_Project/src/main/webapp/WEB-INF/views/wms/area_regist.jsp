...
<div class="main-panel">
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">구역 등록하기</h4>
              <form action="RegistAreaPro.wms" class="form-sample"  method="post" onsubmit="return submitCheck();" id="registForm">
                <p class="card-description">warehouse area regist</p>
                
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">창고명</label>
                      <div class="col-sm-9">
                        <span class="form-control">${param.wh_name }</span>
                      </div>
                    </div>
                   </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">신규 구역명</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="wh_area" id="wh_area" required="required"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="template-demo" style="text-align: right;">
                  	 ...
                  	 <input type="hidden" name="wh_name" value="${param.wh_name }">
	                 <input type="submit" id="sub-btn" class="btn btn-primary mr-2" value="등록" location.href='RegistAreaPro.wms?wh_name=${param.wh_name }&wh_area=${ar.wh_area }'">
