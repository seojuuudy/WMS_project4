					...
					success : function(data) {
							...
							for(let i = 0; i < data.length; i++) {
								let result = "<tr>"
											...
											+ "<td name='wh_loc_in_area'><input type='text' class='form-control' name='wh_loc_in_area_arr' value='" + data[i].wh_loc_in_area + "' readonly='readonly'></td>"
											...
											+ "<td class='moving_area'><input type='text' name='wh_loc_in_area_arr' class='form-control' id='wh_loc_in_area_arr" + i + "' class='wh_loc_in_area_arr'>&nbsp;<input type='button' name='area_btn' onclick='area_search(" + i + ")' class='btn btn-sm btn-outline-primary' value='위치선택'></td>"
