			        ...
			        <div class="template-demo" style="text-align: right;">
						...
						<c:choose>
							<c:when test="${pageNum > 1}">
								<input type="button" class="btn btn-sm btn-outline-primary" value="이전" onclick="location.href='SearchList.out?pageNum=${pageNum - 1}'">
							</c:when>
							<c:otherwise>
						...
						<c:choose>
							<c:when test="${pageNum < pageInfo.maxPage}">
								<input type="button" class="btn btn-sm btn-outline-primary" value="다음" onclick="location.href='SearchList.out?pageNum=${pageNum + 1}'">
							</c:when>
							<c:otherwise>
