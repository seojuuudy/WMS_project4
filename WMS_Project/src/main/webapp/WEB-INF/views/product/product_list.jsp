		...
		<form action="GroupList.pr">
                        ...
                        <div class="input-group-prepend">
                          <select name="searchType" id="searchType" class="btn btn-sm btn-outline-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <option class="dropdown-item" value="productName" <c:if test="${param.searchType eq 'productName'}">selected</c:if>>이름</option>
                            <option class="dropdown-item" value="productCd" <c:if test="${param.searchType eq 'productCd'}">selected</c:if>>품목 코드</option>
                            <option class="dropdown-item" value="client" <c:if test="${param.searchType eq 'client'}">selected</c:if>>거래처</option>
                          </select>
                        </div>
