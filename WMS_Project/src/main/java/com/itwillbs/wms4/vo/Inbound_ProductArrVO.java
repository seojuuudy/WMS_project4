...
public class Inbound_ProductArrVO {
	...
	public Inbound_ProductArrVO(String[] in_schedule_cd, int[] in_schedule_qty, int[] in_qty, Date[] in_date,
			...
			int[] wh_loc_in_area_cd, String[] wh_area, int[] wh_area_cd, int[] c_stock_cd, int[] order_qty) {
		super();
	...
	public String toString() {
		return "Inbound_ProductArrVO [in_schedule_cd=" + Arrays.toString(in_schedule_cd) + ", in_schedule_qty="
				...
				+ Arrays.toString(size_des) + ", locationcd=" + Arrays.toString(locationcd) + ", location_cd="
				+ Arrays.toString(location_cd) + ", wh_loc_in_area=" + Arrays.toString(wh_loc_in_area)
				+ ", wh_loc_in_area_cd=" + Arrays.toString(wh_loc_in_area_cd) + ", wh_area=" + Arrays.toString(wh_area)
				+ ", wh_area_cd=" + Arrays.toString(wh_area_cd) + ", c_stock_cd=" + Arrays.toString(c_stock_cd)
				+ ", order_qty=" + Arrays.toString(order_qty) + "]";
	}
